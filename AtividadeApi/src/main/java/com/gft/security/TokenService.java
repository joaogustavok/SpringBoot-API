...
public class TokenService {
	...
	public String gerarToken(Authentication authentication) {
		Starter logado = (Starter) authentication.getPrincipal();
		Date hoje = new Date();
		Date dataExpiracao = new Date(hoje.getTime() + Long.parseLong(expiration));
		return Jwts.builder().setIssuer("DESAFIOAPI").setSubject(logado.getId().toString()).setIssuedAt(hoje)
	...
	public Long getIdStarter(String token) {
